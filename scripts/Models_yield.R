...
#Fit LMM
model <- glmmTMB(Yield_kg.ha_HR14 ~ Treatment + (1|Field), data = Yield, family = gaussian)
summary(model)
...
model_no5 <- glmmTMB(Yield_kg.ha_HR14 ~ Treatment + (1|Field), data = Yield_no5, family = gaussian)
summary(model_no5)
